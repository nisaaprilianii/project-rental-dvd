...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Kelola Data Peminjaman <a href="/peminjaman/tambah" class="btn btn-info" style="float:right;">Tambah</a></h4>
                    <a href="/peminjaman/cetak" target="_blank" class="btn btn-success"><span class="fa fa-print"></span>Cetak Laporan</a>
