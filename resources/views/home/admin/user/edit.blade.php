                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="/user/{{$user->id}}/update" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ $user->name}}" id="exampleInputUsername1" placeholder="Masukan Nama Admin" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Username</label>
                            <input type="text" class="form-control" name="username" value="{{ $user->username}}" id="exampleInputUsername1" placeholder="Masukan Username Anda" required>
                        </div>
                        <div class="form-group">
